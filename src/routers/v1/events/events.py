...
from routers.dependencies.security import admin_user_authorizer
...
@router.get("/events", response_model=EventsCollection, dependencies=[Depends(admin_user_authorizer)])
